...
> \Swagger\Client\Eve\Model\GetCharactersCharacterIdClonesOk getCharactersCharacterIdClones($character_id, $datasource, $if_none_match, $token, $user_agent, $x_user_agent)
...
try {
    $result = $apiInstance->getCharactersCharacterIdClones($character_id, $datasource, $if_none_match, $token, $user_agent, $x_user_agent);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->getCharactersCharacterIdImplants($character_id, $datasource, $if_none_match, $token, $user_agent, $x_user_agent);
    print_r($result);
} catch (Exception $e) {
