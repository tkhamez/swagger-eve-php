...
> object getCharactersCharacterIdAttributes($character_id, $datasource, $if_none_match, $token)
...
> object getCharactersCharacterIdSkills($character_id, $datasource, $if_none_match, $token)
