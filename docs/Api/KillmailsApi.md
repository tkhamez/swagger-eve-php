...
> \Swagger\Client\Eve\Model\GetCharactersCharacterIdKillmailsRecent200Ok[] getCharactersCharacterIdKillmailsRecent($character_id, $datasource, $if_none_match, $max_count, $max_kill_id, $token, $user_agent, $x_user_agent)
...
> \Swagger\Client\Eve\Model\GetCorporationsCorporationIdKillmailsRecent200Ok[] getCorporationsCorporationIdKillmailsRecent($corporation_id, $datasource, $if_none_match, $max_kill_id, $token, $user_agent, $x_user_agent)
...
> \Swagger\Client\Eve\Model\GetKillmailsKillmailIdKillmailHashOk getKillmailsKillmailIdKillmailHash($killmail_hash, $killmail_id, $datasource, $if_none_match, $user_agent, $x_user_agent)
