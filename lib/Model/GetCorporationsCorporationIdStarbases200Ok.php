...
class GetCorporationsCorporationIdStarbases200Ok implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['onlined_since'] = $data['onlined_since'] ?? null;
        $this->container['reinforced_until'] = $data['reinforced_until'] ?? null;
        $this->container['starbase_id'] = $data['starbase_id'] ?? null;
        $this->container['state'] = $data['state'] ?? null;
        $this->container['system_id'] = $data['system_id'] ?? null;
        $this->container['type_id'] = $data['type_id'] ?? null;
        $this->container['unanchor_at'] = $data['unanchor_at'] ?? null;
    }
