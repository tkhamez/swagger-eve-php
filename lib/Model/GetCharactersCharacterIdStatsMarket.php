...
class GetCharactersCharacterIdStatsMarket implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_characters_character_id_stats_market';
     ...
     *
     * @param int|null $accept_contracts_courier accept_contracts_courier integer
     *
     * @return $this
     */
     ...
     *
     * @param int|null $accept_contracts_item_exchange accept_contracts_item_exchange integer
     *
     * @return $this
     */
     ...
     *
     * @param int|null $buy_orders_placed buy_orders_placed integer
     *
     * @return $this
     */
     ...
     *
     * @param int|null $cancel_market_order cancel_market_order integer
     *
     * @return $this
     */
     ...
     *
     * @param int|null $create_contracts_auction create_contracts_auction integer
     *
     * @return $this
     */
     ...
     *
     * @param int|null $create_contracts_courier create_contracts_courier integer
     *
     * @return $this
     */
     ...
     *
     * @param int|null $create_contracts_item_exchange create_contracts_item_exchange integer
     *
     * @return $this
     */
     ...
     *
     * @param int|null $deliver_courier_contract deliver_courier_contract integer
     *
     * @return $this
     */
     ...
     * Sets isk_gained
     *
     * @param int|null $isk_gained isk_gained integer
     *
     * @return $this
     */
     ...
     * Sets isk_spent
     *
     * @param int|null $isk_spent isk_spent integer
     *
     * @return $this
     */
     ...
     *
     * @param int|null $modify_market_order modify_market_order integer
     *
     * @return $this
     */
     ...
     *
     * @param int|null $search_contracts search_contracts integer
     *
     * @return $this
     */
     ...
     *
     * @param int|null $sell_orders_placed sell_orders_placed integer
     *
     * @return $this
     */
