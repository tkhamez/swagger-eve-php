 ...
 */
class GetFwLeaderboardsLastWeekLastWeek1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_fw_leaderboards_last_week_last_week_1';
