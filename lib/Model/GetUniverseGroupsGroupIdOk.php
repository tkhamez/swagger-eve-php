 ...
 */
class GetUniverseGroupsGroupIdOk implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['types']) > 10000)) {
            $invalidProperties[] = "invalid value for 'types', number of items must be less than or equal to 10000.";
        }
