...
class GetWarsWarIdOk implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['aggressor'] = $data['aggressor'] ?? null;
        $this->container['allies'] = $data['allies'] ?? null;
        $this->container['declared'] = $data['declared'] ?? null;
        $this->container['defender'] = $data['defender'] ?? null;
        $this->container['finished'] = $data['finished'] ?? null;
        $this->container['id'] = $data['id'] ?? null;
        $this->container['mutual'] = $data['mutual'] ?? null;
        $this->container['open_for_allies'] = $data['open_for_allies'] ?? null;
        $this->container['retracted'] = $data['retracted'] ?? null;
    ...
    public function setAllies($allies)
    {
        ...
        if (!is_null($allies) && (count($allies) > 10000)) {
