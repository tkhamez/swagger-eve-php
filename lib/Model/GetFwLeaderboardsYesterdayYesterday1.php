 ...
 */
class GetFwLeaderboardsYesterdayYesterday1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_fw_leaderboards_yesterday_yesterday_1';
