 ...
 */
class GetAlliancesAllianceIdIconsOk implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_alliances_alliance_id_icons_ok';
