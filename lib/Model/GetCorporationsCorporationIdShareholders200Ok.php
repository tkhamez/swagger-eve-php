...
class GetCorporationsCorporationIdShareholders200Ok implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['share_count'] = $data['share_count'] ?? null;
        $this->container['shareholder_id'] = $data['shareholder_id'] ?? null;
        $this->container['shareholder_type'] = $data['shareholder_type'] ?? null;
    }
