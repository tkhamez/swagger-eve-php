 ...
 */
class PutFleetsFleetIdNewSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'put_fleets_fleet_id_new_settings';
    ...
    {
        $this->container['is_free_move'] = $data['is_free_move'] ?? null;
        $this->container['motd'] = $data['motd'] ?? null;
    }
