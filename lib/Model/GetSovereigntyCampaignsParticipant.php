 ...
 */
class GetSovereigntyCampaignsParticipant implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_sovereignty_campaigns_participant';
