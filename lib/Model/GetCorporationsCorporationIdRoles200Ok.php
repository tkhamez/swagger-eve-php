...
class GetCorporationsCorporationIdRoles200Ok implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['grantable_roles']) && (count($this->container['grantable_roles']) > 100)) {
            $invalidProperties[] = "invalid value for 'grantable_roles', number of items must be less than or equal to 100.";
        }

        if (!is_null($this->container['grantable_roles_at_base']) && (count($this->container['grantable_roles_at_base']) > 100)) {
            $invalidProperties[] = "invalid value for 'grantable_roles_at_base', number of items must be less than or equal to 100.";
        }

        if (!is_null($this->container['grantable_roles_at_hq']) && (count($this->container['grantable_roles_at_hq']) > 100)) {
            $invalidProperties[] = "invalid value for 'grantable_roles_at_hq', number of items must be less than or equal to 100.";
        }

        if (!is_null($this->container['grantable_roles_at_other']) && (count($this->container['grantable_roles_at_other']) > 100)) {
            $invalidProperties[] = "invalid value for 'grantable_roles_at_other', number of items must be less than or equal to 100.";
        }
