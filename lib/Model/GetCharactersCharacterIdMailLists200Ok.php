 ...
 */
class GetCharactersCharacterIdMailLists200Ok implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['mailing_list_id'] = $data['mailing_list_id'] ?? null;
