 ...
 */
class GetUniverseSystemKills200Ok implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['npc_kills'] = $data['npc_kills'] ?? null;
        $this->container['pod_kills'] = $data['pod_kills'] ?? null;
        $this->container['ship_kills'] = $data['ship_kills'] ?? null;
