 ...
 */
class GetCharactersCharacterIdFwStatsKills implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_characters_character_id_fw_stats_kills';
