 ...
 */
class GetFwLeaderboardsCorporationsOk implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_fw_leaderboards_corporations_ok';
