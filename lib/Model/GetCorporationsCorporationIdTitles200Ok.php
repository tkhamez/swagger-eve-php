...
class GetCorporationsCorporationIdTitles200Ok implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['grantable_roles'] = $data['grantable_roles'] ?? null;
        $this->container['grantable_roles_at_base'] = $data['grantable_roles_at_base'] ?? null;
        $this->container['grantable_roles_at_hq'] = $data['grantable_roles_at_hq'] ?? null;
        $this->container['grantable_roles_at_other'] = $data['grantable_roles_at_other'] ?? null;
        $this->container['name'] = $data['name'] ?? null;
        $this->container['roles'] = $data['roles'] ?? null;
        $this->container['roles_at_base'] = $data['roles_at_base'] ?? null;
        $this->container['roles_at_hq'] = $data['roles_at_hq'] ?? null;
        $this->container['roles_at_other'] = $data['roles_at_other'] ?? null;
        $this->container['title_id'] = $data['title_id'] ?? null;
    }
