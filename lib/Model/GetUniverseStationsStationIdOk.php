...
class GetUniverseStationsStationIdOk implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['max_dockable_ship_volume'] = $data['max_dockable_ship_volume'] ?? null;
        $this->container['name'] = $data['name'] ?? null;
        $this->container['office_rental_cost'] = $data['office_rental_cost'] ?? null;
        $this->container['owner'] = $data['owner'] ?? null;
        $this->container['position'] = $data['position'] ?? null;
        $this->container['race_id'] = $data['race_id'] ?? null;
        $this->container['reprocessing_efficiency'] = $data['reprocessing_efficiency'] ?? null;
        $this->container['reprocessing_stations_take'] = $data['reprocessing_stations_take'] ?? null;
