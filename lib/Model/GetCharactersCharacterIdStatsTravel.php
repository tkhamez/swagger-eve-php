...
class GetCharactersCharacterIdStatsTravel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_characters_character_id_stats_travel';
     ...
     *
     * @param int|null $acceleration_gate_activations acceleration_gate_activations integer
     *
     * @return $this
     */
     ...
     * Sets align_to
     *
     * @param int|null $align_to align_to integer
     *
     * @return $this
     */
     ...
     *
     * @param int|null $distance_warped_high_sec distance_warped_high_sec integer
     *
     * @return $this
     */
     ...
     *
     * @param int|null $distance_warped_low_sec distance_warped_low_sec integer
     *
     * @return $this
     */
     ...
     *
     * @param int|null $distance_warped_null_sec distance_warped_null_sec integer
     *
     * @return $this
     */
     ...
     *
     * @param int|null $distance_warped_wormhole distance_warped_wormhole integer
     *
     * @return $this
     */
     ...
     * Sets docks_high_sec
     *
     * @param int|null $docks_high_sec docks_high_sec integer
     *
     * @return $this
     */
     ...
     * Sets docks_low_sec
     *
     * @param int|null $docks_low_sec docks_low_sec integer
     *
     * @return $this
     */
     ...
     * Sets docks_null_sec
     *
     * @param int|null $docks_null_sec docks_null_sec integer
     *
     * @return $this
     */
     ...
     *
     * @param int|null $jumps_stargate_high_sec jumps_stargate_high_sec integer
     *
     * @return $this
     */
     ...
     *
     * @param int|null $jumps_stargate_low_sec jumps_stargate_low_sec integer
     *
     * @return $this
     */
     ...
     *
     * @param int|null $jumps_stargate_null_sec jumps_stargate_null_sec integer
     *
     * @return $this
     */
     ...
     * Sets jumps_wormhole
     *
     * @param int|null $jumps_wormhole jumps_wormhole integer
     *
     * @return $this
     */
     ...
     * Sets warps_high_sec
     *
     * @param int|null $warps_high_sec warps_high_sec integer
     *
     * @return $this
     */
     ...
     * Sets warps_low_sec
     *
     * @param int|null $warps_low_sec warps_low_sec integer
     *
     * @return $this
     */
     ...
     * Sets warps_null_sec
     *
     * @param int|null $warps_null_sec warps_null_sec integer
     *
     * @return $this
     */
     ...
     *
     * @param int|null $warps_to_bookmark warps_to_bookmark integer
     *
     * @return $this
     */
     ...
     *
     * @param int|null $warps_to_celestial warps_to_celestial integer
     *
     * @return $this
     */
     ...
     *
     * @param int|null $warps_to_fleet_member warps_to_fleet_member integer
     *
     * @return $this
     */
     ...
     *
     * @param int|null $warps_to_scan_result warps_to_scan_result integer
     *
     * @return $this
     */
     ...
     * Sets warps_wormhole
     *
     * @param int|null $warps_wormhole warps_wormhole integer
     *
     * @return $this
     */
