...
class GetSovereigntyCampaigns200Ok implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['attackers_score'] = $data['attackers_score'] ?? null;
        $this->container['campaign_id'] = $data['campaign_id'] ?? null;
        $this->container['constellation_id'] = $data['constellation_id'] ?? null;
        $this->container['defender_id'] = $data['defender_id'] ?? null;
        $this->container['defender_score'] = $data['defender_score'] ?? null;
    ...
    public function setParticipants($participants)
    {
        ...
        if (!is_null($participants) && (count($participants) > 5000)) {
