...
class GetSovereigntyStructures200Ok implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['structure_type_id'] = $data['structure_type_id'] ?? null;
        $this->container['vulnerability_occupancy_level'] = $data['vulnerability_occupancy_level'] ?? null;
        $this->container['vulnerable_end_time'] = $data['vulnerable_end_time'] ?? null;
        $this->container['vulnerable_start_time'] = $data['vulnerable_start_time'] ?? null;
    }
