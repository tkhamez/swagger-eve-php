 ...
 */
class GetCorporationsCorporationIdMembersTitles200Ok implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_corporations_corporation_id_members_titles_200_ok';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['titles']) > 16)) {
            $invalidProperties[] = "invalid value for 'titles', number of items must be less than or equal to 16.";
        }
