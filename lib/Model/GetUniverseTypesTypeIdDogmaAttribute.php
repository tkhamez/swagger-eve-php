 ...
 */
class GetUniverseTypesTypeIdDogmaAttribute implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_universe_types_type_id_dogma_attribute';
