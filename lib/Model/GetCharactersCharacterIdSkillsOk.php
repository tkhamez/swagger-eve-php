 ...
 */
class GetCharactersCharacterIdSkillsOk implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_characters_character_id_skills_ok';
    ...
    protected static $openAPITypes = [
        'skills' => '\Swagger\Client\Eve\Model\GetCharactersCharacterIdSkillsSkill[]',
        'total_sp' => 'int',
        'unallocated_sp' => 'int'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['total_sp'] = $data['total_sp'] ?? null;
        $this->container['unallocated_sp'] = $data['unallocated_sp'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['skills']) > 1000)) {
            $invalidProperties[] = "invalid value for 'skills', number of items must be less than or equal to 1000.";
        }
     ...
     * Gets skills
     *
     * @return \Swagger\Client\Eve\Model\GetCharactersCharacterIdSkillsSkill[]
     */
     ...
     * Sets skills
     *
     * @param \Swagger\Client\Eve\Model\GetCharactersCharacterIdSkillsSkill[] $skills skills array
     *
     * @return self
     */
