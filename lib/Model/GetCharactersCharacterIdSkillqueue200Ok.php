...
class GetCharactersCharacterIdSkillqueue200Ok implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['finished_level'] = $data['finished_level'] ?? null;
        $this->container['level_end_sp'] = $data['level_end_sp'] ?? null;
        $this->container['level_start_sp'] = $data['level_start_sp'] ?? null;
        $this->container['queue_position'] = $data['queue_position'] ?? null;
        $this->container['skill_id'] = $data['skill_id'] ?? null;
        $this->container['start_date'] = $data['start_date'] ?? null;
        $this->container['training_start_sp'] = $data['training_start_sp'] ?? null;
    }
