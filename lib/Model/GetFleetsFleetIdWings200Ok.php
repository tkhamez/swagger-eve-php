 ...
 */
class GetFleetsFleetIdWings200Ok implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_fleets_fleet_id_wings_200_ok';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['squads'] = $data['squads'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['squads']) > 25)) {
            $invalidProperties[] = "invalid value for 'squads', number of items must be less than or equal to 25.";
        }
