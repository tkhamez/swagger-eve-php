 ...
 */
class GetSearchOk implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['alliance'] = $data['alliance'] ?? null;
        $this->container['character'] = $data['character'] ?? null;
        $this->container['constellation'] = $data['constellation'] ?? null;
        $this->container['corporation'] = $data['corporation'] ?? null;
        $this->container['faction'] = $data['faction'] ?? null;
        $this->container['inventory_type'] = $data['inventory_type'] ?? null;
        $this->container['region'] = $data['region'] ?? null;
        $this->container['solar_system'] = $data['solar_system'] ?? null;
        $this->container['station'] = $data['station'] ?? null;
    }
    ...
    public function setAgent($agent)
    {
        ...
        if (!is_null($agent) && (count($agent) > 500)) {
            throw new \InvalidArgumentException('invalid value for $agent when calling GetSearchOk., number of items must be less than or equal to 500.');
        }
    ...
    public function setAlliance($alliance)
    {
        ...
        if (!is_null($alliance) && (count($alliance) > 500)) {
            throw new \InvalidArgumentException('invalid value for $alliance when calling GetSearchOk., number of items must be less than or equal to 500.');
        }
    ...
    public function setCharacter($character)
    {
        ...
        if (!is_null($character) && (count($character) > 500)) {
            throw new \InvalidArgumentException('invalid value for $character when calling GetSearchOk., number of items must be less than or equal to 500.');
        }
    ...
    public function setConstellation($constellation)
    {
        ...
        if (!is_null($constellation) && (count($constellation) > 500)) {
            throw new \InvalidArgumentException('invalid value for $constellation when calling GetSearchOk., number of items must be less than or equal to 500.');
        }
    ...
    public function setCorporation($corporation)
    {
        ...
        if (!is_null($corporation) && (count($corporation) > 500)) {
            throw new \InvalidArgumentException('invalid value for $corporation when calling GetSearchOk., number of items must be less than or equal to 500.');
        }
    ...
    public function setFaction($faction)
    {
        ...
        if (!is_null($faction) && (count($faction) > 500)) {
            throw new \InvalidArgumentException('invalid value for $faction when calling GetSearchOk., number of items must be less than or equal to 500.');
        }
    ...
    public function setInventoryType($inventory_type)
    {
        ...
        if (!is_null($inventory_type) && (count($inventory_type) > 500)) {
            throw new \InvalidArgumentException('invalid value for $inventory_type when calling GetSearchOk., number of items must be less than or equal to 500.');
        }
    ...
    public function setRegion($region)
    {
        ...
        if (!is_null($region) && (count($region) > 500)) {
            throw new \InvalidArgumentException('invalid value for $region when calling GetSearchOk., number of items must be less than or equal to 500.');
        }
    ...
    public function setSolarSystem($solar_system)
    {
        ...
        if (!is_null($solar_system) && (count($solar_system) > 500)) {
            throw new \InvalidArgumentException('invalid value for $solar_system when calling GetSearchOk., number of items must be less than or equal to 500.');
        }
    ...
    public function setStation($station)
    {
        ...
        if (!is_null($station) && (count($station) > 500)) {
            throw new \InvalidArgumentException('invalid value for $station when calling GetSearchOk., number of items must be less than or equal to 500.');
        }
