 ...
 */
class GetUniverseSchematicsSchematicIdOk implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['cycle_time'] = $data['cycle_time'] ?? null;
        $this->container['schematic_name'] = $data['schematic_name'] ?? null;
    }
