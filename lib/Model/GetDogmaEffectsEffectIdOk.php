...
class GetDogmaEffectsEffectIdOk implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['disallow_auto_repeat'] = $data['disallow_auto_repeat'] ?? null;
        $this->container['discharge_attribute_id'] = $data['discharge_attribute_id'] ?? null;
        $this->container['display_name'] = $data['display_name'] ?? null;
        $this->container['duration_attribute_id'] = $data['duration_attribute_id'] ?? null;
        $this->container['effect_category'] = $data['effect_category'] ?? null;
        $this->container['effect_id'] = $data['effect_id'] ?? null;
        $this->container['electronic_chance'] = $data['electronic_chance'] ?? null;
        $this->container['falloff_attribute_id'] = $data['falloff_attribute_id'] ?? null;
        $this->container['icon_id'] = $data['icon_id'] ?? null;
        $this->container['is_assistance'] = $data['is_assistance'] ?? null;
        $this->container['is_offensive'] = $data['is_offensive'] ?? null;
        $this->container['is_warp_safe'] = $data['is_warp_safe'] ?? null;
        $this->container['modifiers'] = $data['modifiers'] ?? null;
        $this->container['name'] = $data['name'] ?? null;
        $this->container['post_expression'] = $data['post_expression'] ?? null;
        $this->container['pre_expression'] = $data['pre_expression'] ?? null;
        $this->container['published'] = $data['published'] ?? null;
        $this->container['range_attribute_id'] = $data['range_attribute_id'] ?? null;
        $this->container['range_chance'] = $data['range_chance'] ?? null;
        $this->container['tracking_speed_attribute_id'] = $data['tracking_speed_attribute_id'] ?? null;
    }
    ...
    public function setModifiers($modifiers)
    {
        ...
        if (!is_null($modifiers) && (count($modifiers) > 100)) {
