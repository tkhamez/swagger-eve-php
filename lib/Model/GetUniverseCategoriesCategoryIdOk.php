 ...
 */
class GetUniverseCategoriesCategoryIdOk implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_universe_categories_category_id_ok';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['groups']) > 10000)) {
            $invalidProperties[] = "invalid value for 'groups', number of items must be less than or equal to 10000.";
        }
