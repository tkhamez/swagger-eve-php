 ...
 */
class GetCharactersCharacterIdPortraitOk implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_characters_character_id_portrait_ok';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['px512x512'] = $data['px512x512'] ?? null;
     ...
     * Sets px512x512
     *
     * @param string|null $px512x512 px512x512 string
     *
     * @return self
     */
