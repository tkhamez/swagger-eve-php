...
class SkillsApi
{
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\Client\Eve\Model\GetCharactersCharacterIdAttributesOk' === '\SplFileObject') {
                        ...
                        if ('\Swagger\Client\Eve\Model\GetCharactersCharacterIdAttributesOk' !== 'string') {
     ...
     */
    public function getCharactersCharacterIdAttributesRequest($character_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\Client\Eve\Model\GetCharactersCharacterIdSkillqueue200Ok[]' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Swagger\Client\Eve\Model\GetCharactersCharacterIdSkillqueue200Ok[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCharactersCharacterIdSkillqueueRequest($character_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        // verify the required parameter 'character_id' is set
        if ($character_id === null || (is_array($character_id) && count($character_id) === 0)) {
            throw new \InvalidArgumentException(
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\Client\Eve\Model\GetCharactersCharacterIdSkillsOk' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Swagger\Client\Eve\Model\GetCharactersCharacterIdSkillsOk' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCharactersCharacterIdSkillsRequest($character_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        // verify the required parameter 'character_id' is set
        if ($character_id === null || (is_array($character_id) && count($character_id) === 0)) {
            throw new \InvalidArgumentException(
