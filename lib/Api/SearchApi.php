...
class SearchApi
{
     ...
     * @param  bool|null $strict Whether the search should be a strict match (optional, default to false)
     ...
     */
    public function getCharactersCharacterIdSearch($categories, $character_id, $search, $accept_language = 'en', $datasource = 'tranquility', $if_none_match = null, $language = 'en', $strict = false, $token = null, string $contentType = self::contentTypes['getCharactersCharacterIdSearch'][0])
    {
        list($response) = $this->getCharactersCharacterIdSearchWithHttpInfo($categories, $character_id, $search, $accept_language, $datasource, $if_none_match, $language, $strict, $token, $contentType);
        return $response;
    }
     ...
     */
    public function getCharactersCharacterIdSearchWithHttpInfo($categories, $character_id, $search, $accept_language = 'en', $datasource = 'tranquility', $if_none_match = null, $language = 'en', $strict = false, $token = null, string $contentType = self::contentTypes['getCharactersCharacterIdSearch'][0])
    {
        $request = $this->getCharactersCharacterIdSearchRequest($categories, $character_id, $search, $accept_language, $datasource, $if_none_match, $language, $strict, $token, $contentType);
     ...
     */
    public function getCharactersCharacterIdSearchAsync($categories, $character_id, $search, $accept_language = 'en', $datasource = 'tranquility', $if_none_match = null, $language = 'en', $strict = false, $token = null, string $contentType = self::contentTypes['getCharactersCharacterIdSearch'][0])
    {
        return $this->getCharactersCharacterIdSearchAsyncWithHttpInfo($categories, $character_id, $search, $accept_language, $datasource, $if_none_match, $language, $strict, $token, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCharactersCharacterIdSearchAsyncWithHttpInfo($categories, $character_id, $search, $accept_language = 'en', $datasource = 'tranquility', $if_none_match = null, $language = 'en', $strict = false, $token = null, string $contentType = self::contentTypes['getCharactersCharacterIdSearch'][0])
    {
     ...
     */
    public function getCharactersCharacterIdSearchRequest($categories, $character_id, $search, $accept_language = 'en', $datasource = 'tranquility', $if_none_match = null, $language = 'en', $strict = false, $token = null, string $contentType = self::contentTypes['getCharactersCharacterIdSearch'][0])
    {
