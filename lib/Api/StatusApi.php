...
class StatusApi
{
     ...
     */
    public function getStatusAsync($datasource = null, $if_none_match = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStatusAsyncWithHttpInfo($datasource = null, $if_none_match = null)
    {
        $returnType = 'object';
        $request = $this->getStatusRequest($datasource, $if_none_match);
     ...
     */
    protected function getStatusRequest($datasource = null, $if_none_match = null)
    {
