...
class StatusApi
{
     ...
     */
    public function getStatus($datasource = 'tranquility', $if_none_match = null, $user_agent = null, $x_user_agent = null)
    {
     ...
     */
    public function getStatusWithHttpInfo($datasource = 'tranquility', $if_none_match = null, $user_agent = null, $x_user_agent = null)
    {
        $returnType = '\Swagger\Client\Eve\Model\GetStatusOk';
        $request = $this->getStatusRequest($datasource, $if_none_match, $user_agent, $x_user_agent);
     ...
     */
    public function getStatusAsync($datasource = 'tranquility', $if_none_match = null, $user_agent = null, $x_user_agent = null)
    {
        return $this->getStatusAsyncWithHttpInfo($datasource, $if_none_match, $user_agent, $x_user_agent)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStatusAsyncWithHttpInfo($datasource = 'tranquility', $if_none_match = null, $user_agent = null, $x_user_agent = null)
    {
        $returnType = '\Swagger\Client\Eve\Model\GetStatusOk';
        $request = $this->getStatusRequest($datasource, $if_none_match, $user_agent, $x_user_agent);
     ...
     */
    protected function getStatusRequest($datasource = 'tranquility', $if_none_match = null, $user_agent = null, $x_user_agent = null)
    {
