...
class WalletApi
{
     ...
     */
    public function getCharactersCharacterIdWalletRequest($character_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCharactersCharacterIdWalletJournalRequest($character_id, $datasource = 'tranquility', $if_none_match = null, $page = 1, $token = null)
    {
        // verify the required parameter 'character_id' is set
        if ($character_id === null || (is_array($character_id) && count($character_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCharactersCharacterIdWalletTransactionsRequest($character_id, $datasource = 'tranquility', $from_id = null, $if_none_match = null, $token = null)
    {
        // verify the required parameter 'character_id' is set
        if ($character_id === null || (is_array($character_id) && count($character_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdWalletsRequest($corporation_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdWalletsDivisionJournalRequest($corporation_id, $division, $datasource = 'tranquility', $if_none_match = null, $page = 1, $token = null)
    {
        // verify the required parameter 'corporation_id' is set
        if ($corporation_id === null || (is_array($corporation_id) && count($corporation_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdWalletsDivisionTransactionsRequest($corporation_id, $division, $datasource = 'tranquility', $from_id = null, $if_none_match = null, $token = null)
    {
        // verify the required parameter 'corporation_id' is set
        if ($corporation_id === null || (is_array($corporation_id) && count($corporation_id) === 0)) {
            throw new \InvalidArgumentException(
