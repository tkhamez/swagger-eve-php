...
class FleetsApi
{
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putFleetsFleetIdSquadsSquadIdRequest($fleet_id, $squad_id, $naming, $datasource = 'tranquility', $token = null)
    {
        // verify the required parameter 'fleet_id' is set
        if ($fleet_id === null || (is_array($fleet_id) && count($fleet_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putFleetsFleetIdWingsWingIdRequest($fleet_id, $wing_id, $naming, $datasource = 'tranquility', $token = null)
    {
        // verify the required parameter 'fleet_id' is set
        if ($fleet_id === null || (is_array($fleet_id) && count($fleet_id) === 0)) {
            throw new \InvalidArgumentException(
