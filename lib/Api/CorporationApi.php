...
class CorporationApi
{
    ...
    public function getCorporationsCorporationIdWithHttpInfo($corporation_id, $datasource = 'tranquility', $if_none_match = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdOk' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdOk' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\Client\Eve\Model\GetCorporationsCorporationIdOk', []),
                ...
                case 404:
                    if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdNotFound' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdNotFound' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\Client\Eve\Model\GetCorporationsCorporationIdNotFound', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 420:
     ...
     */
    public function getCorporationsCorporationIdRequest($corporation_id, $datasource = 'tranquility', $if_none_match = null)
    {
    ...
    public function getCorporationsCorporationIdAlliancehistoryWithHttpInfo($corporation_id, $datasource = 'tranquility', $if_none_match = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdAlliancehistory200Ok[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdAlliancehistory200Ok[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\Client\Eve\Model\GetCorporationsCorporationIdAlliancehistory200Ok[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdAlliancehistoryRequest($corporation_id, $datasource = 'tranquility', $if_none_match = null)
    {
        // verify the required parameter 'corporation_id' is set
        if ($corporation_id === null || (is_array($corporation_id) && count($corporation_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function getCorporationsCorporationIdBlueprintsWithHttpInfo($corporation_id, $datasource = 'tranquility', $if_none_match = null, $page = 1, $token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdBlueprints200Ok[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdBlueprints200Ok[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\Client\Eve\Model\GetCorporationsCorporationIdBlueprints200Ok[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdBlueprintsRequest($corporation_id, $datasource = 'tranquility', $if_none_match = null, $page = 1, $token = null)
    {
        // verify the required parameter 'corporation_id' is set
        if ($corporation_id === null || (is_array($corporation_id) && count($corporation_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function getCorporationsCorporationIdContainersLogsWithHttpInfo($corporation_id, $datasource = 'tranquility', $if_none_match = null, $page = 1, $token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdContainersLogs200Ok[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdContainersLogs200Ok[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\Client\Eve\Model\GetCorporationsCorporationIdContainersLogs200Ok[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdContainersLogsRequest($corporation_id, $datasource = 'tranquility', $if_none_match = null, $page = 1, $token = null)
    {
        // verify the required parameter 'corporation_id' is set
        if ($corporation_id === null || (is_array($corporation_id) && count($corporation_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function getCorporationsCorporationIdDivisionsWithHttpInfo($corporation_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdDivisionsOk' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdDivisionsOk' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\Client\Eve\Model\GetCorporationsCorporationIdDivisionsOk', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdDivisionsRequest($corporation_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        // verify the required parameter 'corporation_id' is set
        if ($corporation_id === null || (is_array($corporation_id) && count($corporation_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function getCorporationsCorporationIdFacilitiesWithHttpInfo($corporation_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdFacilities200Ok[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdFacilities200Ok[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\Client\Eve\Model\GetCorporationsCorporationIdFacilities200Ok[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdFacilitiesRequest($corporation_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        // verify the required parameter 'corporation_id' is set
        if ($corporation_id === null || (is_array($corporation_id) && count($corporation_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function getCorporationsCorporationIdIconsWithHttpInfo($corporation_id, $datasource = 'tranquility', $if_none_match = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdIconsOk' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdIconsOk' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\Client\Eve\Model\GetCorporationsCorporationIdIconsOk', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                ...
                case 404:
                    if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdIconsNotFound' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdIconsNotFound' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\Client\Eve\Model\GetCorporationsCorporationIdIconsNotFound', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 420:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdIconsRequest($corporation_id, $datasource = 'tranquility', $if_none_match = null)
    {
        // verify the required parameter 'corporation_id' is set
        if ($corporation_id === null || (is_array($corporation_id) && count($corporation_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function getCorporationsCorporationIdMedalsWithHttpInfo($corporation_id, $datasource = 'tranquility', $if_none_match = null, $page = 1, $token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdMedals200Ok[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdMedals200Ok[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\Client\Eve\Model\GetCorporationsCorporationIdMedals200Ok[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdMedalsRequest($corporation_id, $datasource = 'tranquility', $if_none_match = null, $page = 1, $token = null)
    {
        // verify the required parameter 'corporation_id' is set
        if ($corporation_id === null || (is_array($corporation_id) && count($corporation_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function getCorporationsCorporationIdMedalsIssuedWithHttpInfo($corporation_id, $datasource = 'tranquility', $if_none_match = null, $page = 1, $token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdMedalsIssued200Ok[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdMedalsIssued200Ok[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\Client\Eve\Model\GetCorporationsCorporationIdMedalsIssued200Ok[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdMedalsIssuedRequest($corporation_id, $datasource = 'tranquility', $if_none_match = null, $page = 1, $token = null)
    {
        // verify the required parameter 'corporation_id' is set
        if ($corporation_id === null || (is_array($corporation_id) && count($corporation_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdMembersRequest($corporation_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        // verify the required parameter 'corporation_id' is set
        if ($corporation_id === null || (is_array($corporation_id) && count($corporation_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdMembersLimitRequest($corporation_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        // verify the required parameter 'corporation_id' is set
        if ($corporation_id === null || (is_array($corporation_id) && count($corporation_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function getCorporationsCorporationIdMembersTitlesWithHttpInfo($corporation_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdMembersTitles200Ok[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdMembersTitles200Ok[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\Client\Eve\Model\GetCorporationsCorporationIdMembersTitles200Ok[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdMembersTitlesRequest($corporation_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        // verify the required parameter 'corporation_id' is set
        if ($corporation_id === null || (is_array($corporation_id) && count($corporation_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function getCorporationsCorporationIdMembertrackingWithHttpInfo($corporation_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdMembertracking200Ok[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdMembertracking200Ok[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\Client\Eve\Model\GetCorporationsCorporationIdMembertracking200Ok[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdMembertrackingRequest($corporation_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        // verify the required parameter 'corporation_id' is set
        if ($corporation_id === null || (is_array($corporation_id) && count($corporation_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function getCorporationsCorporationIdRolesWithHttpInfo($corporation_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdRoles200Ok[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdRoles200Ok[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\Client\Eve\Model\GetCorporationsCorporationIdRoles200Ok[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdRolesRequest($corporation_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        // verify the required parameter 'corporation_id' is set
        if ($corporation_id === null || (is_array($corporation_id) && count($corporation_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function getCorporationsCorporationIdRolesHistoryWithHttpInfo($corporation_id, $datasource = 'tranquility', $if_none_match = null, $page = 1, $token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdRolesHistory200Ok[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdRolesHistory200Ok[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\Client\Eve\Model\GetCorporationsCorporationIdRolesHistory200Ok[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdRolesHistoryRequest($corporation_id, $datasource = 'tranquility', $if_none_match = null, $page = 1, $token = null)
    {
        // verify the required parameter 'corporation_id' is set
        if ($corporation_id === null || (is_array($corporation_id) && count($corporation_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function getCorporationsCorporationIdShareholdersWithHttpInfo($corporation_id, $datasource = 'tranquility', $if_none_match = null, $page = 1, $token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdShareholders200Ok[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdShareholders200Ok[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\Client\Eve\Model\GetCorporationsCorporationIdShareholders200Ok[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdShareholdersRequest($corporation_id, $datasource = 'tranquility', $if_none_match = null, $page = 1, $token = null)
    {
        // verify the required parameter 'corporation_id' is set
        if ($corporation_id === null || (is_array($corporation_id) && count($corporation_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function getCorporationsCorporationIdStandingsWithHttpInfo($corporation_id, $datasource = 'tranquility', $if_none_match = null, $page = 1, $token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdStandings200Ok[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdStandings200Ok[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\Client\Eve\Model\GetCorporationsCorporationIdStandings200Ok[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdStandingsRequest($corporation_id, $datasource = 'tranquility', $if_none_match = null, $page = 1, $token = null)
    {
        // verify the required parameter 'corporation_id' is set
        if ($corporation_id === null || (is_array($corporation_id) && count($corporation_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function getCorporationsCorporationIdStarbasesWithHttpInfo($corporation_id, $datasource = 'tranquility', $if_none_match = null, $page = 1, $token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdStarbases200Ok[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdStarbases200Ok[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\Client\Eve\Model\GetCorporationsCorporationIdStarbases200Ok[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdStarbasesRequest($corporation_id, $datasource = 'tranquility', $if_none_match = null, $page = 1, $token = null)
    {
        // verify the required parameter 'corporation_id' is set
        if ($corporation_id === null || (is_array($corporation_id) && count($corporation_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function getCorporationsCorporationIdStarbasesStarbaseIdWithHttpInfo($corporation_id, $starbase_id, $system_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdStarbasesStarbaseIdOk' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdStarbasesStarbaseIdOk' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\Client\Eve\Model\GetCorporationsCorporationIdStarbasesStarbaseIdOk', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdStarbasesStarbaseIdRequest($corporation_id, $starbase_id, $system_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        // verify the required parameter 'corporation_id' is set
        if ($corporation_id === null || (is_array($corporation_id) && count($corporation_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function getCorporationsCorporationIdStructuresWithHttpInfo($corporation_id, $accept_language = 'en', $datasource = 'tranquility', $if_none_match = null, $language = 'en', $page = 1, $token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdStructures200Ok[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdStructures200Ok[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\Client\Eve\Model\GetCorporationsCorporationIdStructures200Ok[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdStructuresRequest($corporation_id, $accept_language = 'en', $datasource = 'tranquility', $if_none_match = null, $language = 'en', $page = 1, $token = null)
    {
        // verify the required parameter 'corporation_id' is set
        if ($corporation_id === null || (is_array($corporation_id) && count($corporation_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function getCorporationsCorporationIdTitlesWithHttpInfo($corporation_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdTitles200Ok[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Swagger\Client\Eve\Model\GetCorporationsCorporationIdTitles200Ok[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Swagger\Client\Eve\Model\GetCorporationsCorporationIdTitles200Ok[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdTitlesRequest($corporation_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        // verify the required parameter 'corporation_id' is set
        if ($corporation_id === null || (is_array($corporation_id) && count($corporation_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsNpccorpsRequest($datasource = 'tranquility', $if_none_match = null)
    {
