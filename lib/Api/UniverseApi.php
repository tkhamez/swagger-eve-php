...
class UniverseApi
{
     ...
     * Bulk names to IDs
     *
     * @param  string[] $request_body The names to resolve (required)
     * @param  string $accept_language Language to use in the response (optional, default to 'en-us')
     * @param  string $datasource The server name you would like data from (optional, default to 'tranquility')
     * @param  string $language Language to use in the response, takes precedence over Accept-Language (optional, default to 'en-us')
     *
     ...
     */
    public function postUniverseIds($request_body, $accept_language = 'en-us', $datasource = 'tranquility', $language = 'en-us')
    {
        list($response) = $this->postUniverseIdsWithHttpInfo($request_body, $accept_language, $datasource, $language);
        return $response;
    }
     ...
     */
    public function postUniverseIdsWithHttpInfo($request_body, $accept_language = 'en-us', $datasource = 'tranquility', $language = 'en-us')
    {
        $request = $this->postUniverseIdsRequest($request_body, $accept_language, $datasource, $language);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUniverseIdsAsync($request_body, $accept_language = 'en-us', $datasource = 'tranquility', $language = 'en-us')
    {
        return $this->postUniverseIdsAsyncWithHttpInfo($request_body, $accept_language, $datasource, $language)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUniverseIdsAsyncWithHttpInfo($request_body, $accept_language = 'en-us', $datasource = 'tranquility', $language = 'en-us')
    {
        $returnType = '\Swagger\Client\Eve\Model\PostUniverseIdsOk';
        $request = $this->postUniverseIdsRequest($request_body, $accept_language, $datasource, $language);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postUniverseIdsRequest($request_body, $accept_language = 'en-us', $datasource = 'tranquility', $language = 'en-us')
    {
     ...
     *
     * @param  int[] $request_body The ids to resolve (required)
     * @param  string $datasource The server name you would like data from (optional, default to 'tranquility')
     *
     * @throws \Swagger\Client\Eve\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function postUniverseNames($request_body, $datasource = 'tranquility')
    {
        list($response) = $this->postUniverseNamesWithHttpInfo($request_body, $datasource);
        return $response;
    }
     ...
     */
    public function postUniverseNamesWithHttpInfo($request_body, $datasource = 'tranquility')
    {
        $request = $this->postUniverseNamesRequest($request_body, $datasource);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUniverseNamesAsync($request_body, $datasource = 'tranquility')
    {
        return $this->postUniverseNamesAsyncWithHttpInfo($request_body, $datasource)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUniverseNamesAsyncWithHttpInfo($request_body, $datasource = 'tranquility')
    {
        $returnType = '\Swagger\Client\Eve\Model\PostUniverseNames200Ok[]';
        $request = $this->postUniverseNamesRequest($request_body, $datasource);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postUniverseNamesRequest($request_body, $datasource = 'tranquility')
    {
        // verify the required parameter 'request_body' is set
        if ($request_body === null || (is_array($request_body) && count($request_body) === 0)) {
            throw new \InvalidArgumentException(
