...
class ClonesApi
{
     ...
     */
    public function getCharactersCharacterIdClonesRequest($character_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCharactersCharacterIdImplantsRequest($character_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        // verify the required parameter 'character_id' is set
        if ($character_id === null || (is_array($character_id) && count($character_id) === 0)) {
            throw new \InvalidArgumentException(
