...
class InsuranceApi
{
     ...
     */
    public function getInsurancePrices($datasource = 'tranquility', $if_none_match = null, $language = 'en-us', $user_agent = null, $x_user_agent = null)
    {
     ...
     */
    public function getInsurancePricesWithHttpInfo($datasource = 'tranquility', $if_none_match = null, $language = 'en-us', $user_agent = null, $x_user_agent = null)
    {
        $returnType = '\Swagger\Client\Eve\Model\GetInsurancePrices200Ok[]';
        $request = $this->getInsurancePricesRequest($datasource, $if_none_match, $language, $user_agent, $x_user_agent);
     ...
     */
    public function getInsurancePricesAsync($datasource = 'tranquility', $if_none_match = null, $language = 'en-us', $user_agent = null, $x_user_agent = null)
    {
        return $this->getInsurancePricesAsyncWithHttpInfo($datasource, $if_none_match, $language, $user_agent, $x_user_agent)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInsurancePricesAsyncWithHttpInfo($datasource = 'tranquility', $if_none_match = null, $language = 'en-us', $user_agent = null, $x_user_agent = null)
    {
        $returnType = '\Swagger\Client\Eve\Model\GetInsurancePrices200Ok[]';
        $request = $this->getInsurancePricesRequest($datasource, $if_none_match, $language, $user_agent, $x_user_agent);
     ...
     */
    protected function getInsurancePricesRequest($datasource = 'tranquility', $if_none_match = null, $language = 'en-us', $user_agent = null, $x_user_agent = null)
    {
