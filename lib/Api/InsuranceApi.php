...
class InsuranceApi
{
     ...
     */
    public function getInsurancePrices($accept_language = 'en', $datasource = 'tranquility', $if_none_match = null, $language = 'en', string $contentType = self::contentTypes['getInsurancePrices'][0])
    {
        list($response) = $this->getInsurancePricesWithHttpInfo($accept_language, $datasource, $if_none_match, $language, $contentType);
        return $response;
    }
     ...
     */
    public function getInsurancePricesWithHttpInfo($accept_language = 'en', $datasource = 'tranquility', $if_none_match = null, $language = 'en', string $contentType = self::contentTypes['getInsurancePrices'][0])
    {
        $request = $this->getInsurancePricesRequest($accept_language, $datasource, $if_none_match, $language, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\Swagger\Client\Eve\Model\GetInsurancePrices200Ok[]' === '\SplFileObject') {
                        ...
                        if ('\Swagger\Client\Eve\Model\GetInsurancePrices200Ok[]' !== 'string') {
                            try {
     ...
     */
    public function getInsurancePricesAsync($accept_language = 'en', $datasource = 'tranquility', $if_none_match = null, $language = 'en', string $contentType = self::contentTypes['getInsurancePrices'][0])
    {
        return $this->getInsurancePricesAsyncWithHttpInfo($accept_language, $datasource, $if_none_match, $language, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInsurancePricesAsyncWithHttpInfo($accept_language = 'en', $datasource = 'tranquility', $if_none_match = null, $language = 'en', string $contentType = self::contentTypes['getInsurancePrices'][0])
    {
        $returnType = '\Swagger\Client\Eve\Model\GetInsurancePrices200Ok[]';
        $request = $this->getInsurancePricesRequest($accept_language, $datasource, $if_none_match, $language, $contentType);
     ...
     */
    public function getInsurancePricesRequest($accept_language = 'en', $datasource = 'tranquility', $if_none_match = null, $language = 'en', string $contentType = self::contentTypes['getInsurancePrices'][0])
    {
