...
class FittingsApi
{
     ...
     */
    public function deleteCharactersCharacterIdFittingsFittingIdRequest($character_id, $fitting_id, $datasource = 'tranquility', $token = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCharactersCharacterIdFittingsRequest($character_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
        // verify the required parameter 'character_id' is set
        if ($character_id === null || (is_array($character_id) && count($character_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postCharactersCharacterIdFittingsRequest($character_id, $fitting, $datasource = 'tranquility', $token = null)
    {
        // verify the required parameter 'character_id' is set
        if ($character_id === null || (is_array($character_id) && count($character_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($fitting)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($fitting));
            } else {
                $httpBody = $fitting;
            }
