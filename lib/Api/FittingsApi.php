...
class FittingsApi
{
     ...
     * @param  string $datasource The server name you would like data from (optional, default to 'tranquility')
     * @param  string $token Access token to use if unable to set a header (optional)
     * @param  \Swagger\Client\Eve\Model\PostCharactersCharacterIdFittingsFitting $post_characters_character_id_fittings_fitting post_characters_character_id_fittings_fitting (optional)
     *
     * @throws \Swagger\Client\Eve\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function postCharactersCharacterIdFittings($character_id, $datasource = 'tranquility', $token = null, $post_characters_character_id_fittings_fitting = null)
    {
        list($response) = $this->postCharactersCharacterIdFittingsWithHttpInfo($character_id, $datasource, $token, $post_characters_character_id_fittings_fitting);
        return $response;
    }
     ...
     * @param  string $datasource The server name you would like data from (optional, default to 'tranquility')
     * @param  string $token Access token to use if unable to set a header (optional)
     * @param  \Swagger\Client\Eve\Model\PostCharactersCharacterIdFittingsFitting $post_characters_character_id_fittings_fitting (optional)
     *
     * @throws \Swagger\Client\Eve\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function postCharactersCharacterIdFittingsWithHttpInfo($character_id, $datasource = 'tranquility', $token = null, $post_characters_character_id_fittings_fitting = null)
    {
        $request = $this->postCharactersCharacterIdFittingsRequest($character_id, $datasource, $token, $post_characters_character_id_fittings_fitting);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postCharactersCharacterIdFittingsAsync($character_id, $datasource = 'tranquility', $token = null, $post_characters_character_id_fittings_fitting = null)
    {
        return $this->postCharactersCharacterIdFittingsAsyncWithHttpInfo($character_id, $datasource, $token, $post_characters_character_id_fittings_fitting)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postCharactersCharacterIdFittingsAsyncWithHttpInfo($character_id, $datasource = 'tranquility', $token = null, $post_characters_character_id_fittings_fitting = null)
    {
        $returnType = '\Swagger\Client\Eve\Model\PostCharactersCharacterIdFittingsCreated';
        $request = $this->postCharactersCharacterIdFittingsRequest($character_id, $datasource, $token, $post_characters_character_id_fittings_fitting);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postCharactersCharacterIdFittingsRequest($character_id, $datasource = 'tranquility', $token = null, $post_characters_character_id_fittings_fitting = null)
    {
        // verify the required parameter 'character_id' is set
        if ($character_id === null || (is_array($character_id) && count($character_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // body params
        $_tempBody = null;
        if (isset($post_characters_character_id_fittings_fitting)) {
            $_tempBody = $post_characters_character_id_fittings_fitting;
        }
