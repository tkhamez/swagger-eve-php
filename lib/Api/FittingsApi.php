...
*
     ...
     */
    public function deleteCharactersCharacterIdFittingsFittingIdAsync($character_id, $fitting_id, $datasource = null, $token = null)
    {
...
*
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteCharactersCharacterIdFittingsFittingIdAsyncWithHttpInfo($character_id, $fitting_id, $datasource = null, $token = null)
    {
        $returnType = '';
        $request = $this->deleteCharactersCharacterIdFittingsFittingIdRequest($character_id, $fitting_id, $datasource, $token);
...
*
     ...
     */
    protected function deleteCharactersCharacterIdFittingsFittingIdRequest($character_id, $fitting_id, $datasource = null, $token = null)
    {
...
*
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCharactersCharacterIdFittingsAsync($character_id, $datasource = null, $if_none_match = null, $token = null)
    {
...
*
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCharactersCharacterIdFittingsAsyncWithHttpInfo($character_id, $datasource = null, $if_none_match = null, $token = null)
    {
        $returnType = 'object[]';
        $request = $this->getCharactersCharacterIdFittingsRequest($character_id, $datasource, $if_none_match, $token);
...
*
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCharactersCharacterIdFittingsRequest($character_id, $datasource = null, $if_none_match = null, $token = null)
    {
// verify the required parameter 'character_id' is set
        if ($character_id === null) {
            throw new \InvalidArgumentException(
...
*
     * Create fitting
*
* @param  object $body Details about the new fitting (required)
* @param  int $character_id An EVE character ID (required)
* @param  string $datasource The server name you would like data from (optional)
* @param  string $token Access token to use if unable to set a header (optional)
*
     ...
     * @return object
     */
    public function postCharactersCharacterIdFittings($body$character_id, $datasource = null, $token = null)
    {
        list($response) = $this->postCharactersCharacterIdFittingsWithHttpInfo($body$character_id, $datasource, $token);
        return $response;
    }
...
*
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function postCharactersCharacterIdFittingsWithHttpInfo($body$character_id, $datasource = null, $token = null)
    {
        $returnType = 'object';
        $request = $this->postCharactersCharacterIdFittingsRequest($body$character_id, $datasource, $token);
...
*
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postCharactersCharacterIdFittingsAsync($body$character_id, $datasource = null, $token = null)
    {
        return $this->postCharactersCharacterIdFittingsAsyncWithHttpInfo($body$character_id, $datasource, $token)
            ->then(
                function ($response) {
                    return $response[0];
                }
...
*
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postCharactersCharacterIdFittingsAsyncWithHttpInfo($body$character_id, $datasource = null, $token = null)
    {
        $returnType = 'object';
        $request = $this->postCharactersCharacterIdFittingsRequest($body$character_id, $datasource, $token);
...
*
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postCharactersCharacterIdFittingsRequest($body$character_id, $datasource = null, $token = null)
    {
// verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postCharactersCharacterIdFittings'
            );
        }
// verify the required parameter 'character_id' is set
        if ($character_id === null) {
