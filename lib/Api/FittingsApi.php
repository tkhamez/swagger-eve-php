...
class FittingsApi
{
     ...
     */
    public function getCharactersCharacterIdFittings($character_id, $datasource = 'tranquility', $if_none_match = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
     ...
     */
    public function getCharactersCharacterIdFittingsWithHttpInfo($character_id, $datasource = 'tranquility', $if_none_match = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        $returnType = '\Swagger\Client\Eve\Model\GetCharactersCharacterIdFittings200Ok[]';
        $request = $this->getCharactersCharacterIdFittingsRequest($character_id, $datasource, $if_none_match, $token, $user_agent, $x_user_agent);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCharactersCharacterIdFittingsAsync($character_id, $datasource = 'tranquility', $if_none_match = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        return $this->getCharactersCharacterIdFittingsAsyncWithHttpInfo($character_id, $datasource, $if_none_match, $token, $user_agent, $x_user_agent)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCharactersCharacterIdFittingsAsyncWithHttpInfo($character_id, $datasource = 'tranquility', $if_none_match = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        $returnType = '\Swagger\Client\Eve\Model\GetCharactersCharacterIdFittings200Ok[]';
        $request = $this->getCharactersCharacterIdFittingsRequest($character_id, $datasource, $if_none_match, $token, $user_agent, $x_user_agent);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCharactersCharacterIdFittingsRequest($character_id, $datasource = 'tranquility', $if_none_match = null, $token = null, $user_agent = null, $x_user_agent = null)
    {
        // verify the required parameter 'character_id' is set
        if ($character_id === null) {
            throw new \InvalidArgumentException(
