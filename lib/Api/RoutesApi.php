...
class RoutesApi
{
    ...
    public function getRouteOriginDestinationRequest($destination, $origin, $avoid = null, $connections = null, $datasource = 'tranquility', $flag = 'shortest', $if_none_match = null)
    {
        ...
        // query params
        if (is_array($avoid)) {
            $avoid = ObjectSerializer::serializeCollection($avoid, 'form', true);
        }
        if ($avoid !== null) {
        ...
        if (is_array($connections)) {
            $connections = ObjectSerializer::serializeCollection($connections, 'form', true);
        }
        if ($connections !== null) {
        ...
        // query params
        if (is_array($flag)) {
            $flag = ObjectSerializer::serializeCollection($flag, '', true);
        }
        if ($flag !== null) {
