...
class PlanetaryInteractionApi
{
     ...
     */
    public function getCharactersCharacterIdPlanetsRequest($character_id, $datasource = 'tranquility', $if_none_match = null, $token = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCharactersCharacterIdPlanetsPlanetIdRequest($character_id, $planet_id, $datasource = 'tranquility', $token = null)
    {
        // verify the required parameter 'character_id' is set
        if ($character_id === null || (is_array($character_id) && count($character_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCorporationsCorporationIdCustomsOfficesRequest($corporation_id, $datasource = 'tranquility', $if_none_match = null, $page = 1, $token = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getUniverseSchematicsSchematicIdRequest($schematic_id, $datasource = 'tranquility', $if_none_match = null)
    {
