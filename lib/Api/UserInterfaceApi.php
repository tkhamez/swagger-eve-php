...
*
     ...
     */
    public function postUiAutopilotWaypointAsync($add_to_beginning, $clear_other_waypoints, $destination_id, $datasource = null, $token = null)
    {
...
*
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUiAutopilotWaypointAsyncWithHttpInfo($add_to_beginning, $clear_other_waypoints, $destination_id, $datasource = null, $token = null)
    {
        $returnType = '';
        $request = $this->postUiAutopilotWaypointRequest($add_to_beginning, $clear_other_waypoints, $destination_id, $datasource, $token);
...
*
     ...
     */
    protected function postUiAutopilotWaypointRequest($add_to_beginning, $clear_other_waypoints, $destination_id, $datasource = null, $token = null)
    {
...
*
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUiOpenwindowContractAsync($contract_id, $datasource = null, $token = null)
    {
...
*
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUiOpenwindowContractAsyncWithHttpInfo($contract_id, $datasource = null, $token = null)
    {
        $returnType = '';
        $request = $this->postUiOpenwindowContractRequest($contract_id, $datasource, $token);
...
*
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postUiOpenwindowContractRequest($contract_id, $datasource = null, $token = null)
    {
...
*
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUiOpenwindowInformationAsync($target_id, $datasource = null, $token = null)
    {
...
*
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUiOpenwindowInformationAsyncWithHttpInfo($target_id, $datasource = null, $token = null)
    {
        $returnType = '';
        $request = $this->postUiOpenwindowInformationRequest($target_id, $datasource, $token);
...
*
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postUiOpenwindowInformationRequest($target_id, $datasource = null, $token = null)
    {
...
*
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUiOpenwindowMarketdetailsAsync($type_id, $datasource = null, $token = null)
    {
...
*
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUiOpenwindowMarketdetailsAsyncWithHttpInfo($type_id, $datasource = null, $token = null)
    {
        $returnType = '';
        $request = $this->postUiOpenwindowMarketdetailsRequest($type_id, $datasource, $token);
...
*
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postUiOpenwindowMarketdetailsRequest($type_id, $datasource = null, $token = null)
    {
...
*
* @param  object $body The details of mail to create (required)
* @param  string $datasource The server name you would like data from (optional)
* @param  string $token Access token to use if unable to set a header (optional)
*
     * @throws \Swagger\Client\Eve\ApiException on non-2xx response
     ...
     * @return void
     */
    public function postUiOpenwindowNewmail($body$datasource = null, $token = null)
    {
        $this->postUiOpenwindowNewmailWithHttpInfo($body$datasource, $token);
    }
...
*
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function postUiOpenwindowNewmailWithHttpInfo($body$datasource = null, $token = null)
    {
        $returnType = '';
        $request = $this->postUiOpenwindowNewmailRequest($body$datasource, $token);
...
*
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUiOpenwindowNewmailAsync($body$datasource = null, $token = null)
    {
        return $this->postUiOpenwindowNewmailAsyncWithHttpInfo($body$datasource, $token)
            ->then(
                function ($response) {
                    return $response[0];
                }
...
*
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUiOpenwindowNewmailAsyncWithHttpInfo($body$datasource = null, $token = null)
    {
        $returnType = '';
        $request = $this->postUiOpenwindowNewmailRequest($body$datasource, $token);
...
*
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postUiOpenwindowNewmailRequest($body$datasource = null, $token = null)
    {
// verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling postUiOpenwindowNewmail'
            );
        }
