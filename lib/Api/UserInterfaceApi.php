...
class UserInterfaceApi
{
     ...
     * @param  string $datasource The server name you would like data from (optional, default to 'tranquility')
     * @param  string $token Access token to use if unable to set a header (optional)
     * @param  \Swagger\Client\Eve\Model\PostUiOpenwindowNewmailNewMail $post_ui_openwindow_newmail_new_mail post_ui_openwindow_newmail_new_mail (optional)
     *
     * @throws \Swagger\Client\Eve\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function postUiOpenwindowNewmail($datasource = 'tranquility', $token = null, $post_ui_openwindow_newmail_new_mail = null)
    {
        $this->postUiOpenwindowNewmailWithHttpInfo($datasource, $token, $post_ui_openwindow_newmail_new_mail);
    }
     ...
     * @param  string $datasource The server name you would like data from (optional, default to 'tranquility')
     * @param  string $token Access token to use if unable to set a header (optional)
     * @param  \Swagger\Client\Eve\Model\PostUiOpenwindowNewmailNewMail $post_ui_openwindow_newmail_new_mail (optional)
     *
     * @throws \Swagger\Client\Eve\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function postUiOpenwindowNewmailWithHttpInfo($datasource = 'tranquility', $token = null, $post_ui_openwindow_newmail_new_mail = null)
    {
        $request = $this->postUiOpenwindowNewmailRequest($datasource, $token, $post_ui_openwindow_newmail_new_mail);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUiOpenwindowNewmailAsync($datasource = 'tranquility', $token = null, $post_ui_openwindow_newmail_new_mail = null)
    {
        return $this->postUiOpenwindowNewmailAsyncWithHttpInfo($datasource, $token, $post_ui_openwindow_newmail_new_mail)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUiOpenwindowNewmailAsyncWithHttpInfo($datasource = 'tranquility', $token = null, $post_ui_openwindow_newmail_new_mail = null)
    {
        $returnType = '';
        $request = $this->postUiOpenwindowNewmailRequest($datasource, $token, $post_ui_openwindow_newmail_new_mail);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postUiOpenwindowNewmailRequest($datasource = 'tranquility', $token = null, $post_ui_openwindow_newmail_new_mail = null)
    {
        ...
        // body params
        $_tempBody = null;
        if (isset($post_ui_openwindow_newmail_new_mail)) {
            $_tempBody = $post_ui_openwindow_newmail_new_mail;
        }
